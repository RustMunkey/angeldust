  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close data-slot="sheet-close" className="absolute top-[18px] end-6 text-white/50 hover:text-white transition-colors cursor-pointer">
            <HugeiconsIcon icon={Cancel01Icon} size={28} strokeWidth={1} />
